package com.me.dm.unicodeconvertertool.threads;

import com.me.dm.unicodeconvertertool.util.FileUtil;
...
public class UnescapeUnicodeThread extends Thread
{
	...
	public void run ()
	{
		...
		String unescFileName = FileUtil.getFileNameWithoutExtension(textFile) + "_unescapeUnicode." +
